...
public class ExportBeanExcel<T> {
     ...
     */
    public  void exportExcel(String path,String title, List<String> headersName, List<String> headersId,
                             List<T> dtoList) {
        /*（一）表头--标题栏*/
...
//        style.setAlignment(HSSFCellStyle.ALIGN_CENTER);
    ...
    */
    public static void main(String [] args){
        ...
        list.add(new UserDTO("next").initDetail("venue","http:/","200","zuwei会","https","fa飞蛾发完饭未啊日","185182 联系人"));


        ExportBeanExcel<UserDTO> exportBeanExcelUtil = new ExportBeanExcel();
        exportBeanExcelUtil.exportExcel("/Users/Mecca/Documents/work/mine/Git/spider/src/main/resources/test.xls","测试POI导出EXCEL文档",listName,listId,list);
